...
import { sendAudioVC } from './hooks';
import AAudio  from '../A.wav';
import ABAudio from '../AB.wav';
...
class ListenButtonVC extends React.Component {
  constructor(props) {
    super(props);
  ...
  sendRecording = () => {
    sendAudioVC(this.state.blob, this.setState.bind(this), this.props.setShowModal, this.props.setResults);
  }
  stopRecording = () => {
      ...
      <div className="listen-button">
        ...
        <div className="audio-wrapper">
          <div className="audio-row">
            ...
            <audio controls>
                <source src={AAudio} type="audio/wav"/>
            </audio>
          </div>
